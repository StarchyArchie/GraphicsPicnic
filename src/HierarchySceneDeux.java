...
public class HierarchySceneDeux extends JPanel {
    /**
     * This main() routine makes it possible to run the class HierarchySceneDeux
     * as an application.  It simply creates a window that contains a panel
     * of type HierarchySceneDeux.  The program ends when the user closed the
    ...
    public static void main(String[] args) {
        ...
        HierarchySceneDeux panel = new HierarchySceneDeux();         // Create the panel
    ...
    /**
     * This constructor sets up a HierarchySceneDeux when it is created.  Here, it
     ...
     * @param petals The number of petals for each sunflower
     * The size of the array for height and petals should match
     */
     ...
     * @param numPetals The number of petals to generate around the center (times two actually)
     * The origin of the sunflower is designed to be the base of the stalk
     */
